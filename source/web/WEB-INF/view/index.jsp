	...
	<div>
		<div id="event">
			<div class="e_link">
				...
				<button id="event_btn" type="button">
					<img
						src="https://res.kurly.com/pc/ico/1908/ico_close_fff_84x84.png"
						alt="e_close">
				</button>
			</div>
		</div>
		<div id="header">
			<div class="h_first">
					...
					<div>
						<c:choose>
							<c:when test="${empty loginSsInfo }">
								<a href="${pageContext.request.contextPath }/join.html">회원가입</a>
								<div>|</div>
						...
						<div>
							...
							<div class="h_f_1_a3_hover"
								onclick="location.href='${pageContext.request.contextPath }/notice.html';">
								<div>공지사항</div>
								<div>자주하는 질문</div>
								<div>1:1 문의</div>
								<div>대량주문 문의</div>
				...
				<div class="h_f_2">
					<div id="main_logo"
						...
						<img src="${pageContext.request.contextPath }/images/마켓컬리로고.svg"
							alt="main_logo">
					...
					<div id="buttons">
						...
						<button type="button"></button>
						<button type="button"
							onclick="location.href='${pageContext.request.contextPath }/shopping_basket_guest.html';"></button>
						<div class="buttons_first_hover">
							...
							<div>
								<p>
									<strong>배송지를 등록</strong>하고<br>구매 가능한 상품을 확인하세요!
								</p>
								<div>
									<button
										onclick="location.href='${pageContext.request.contextPath }/login.html';">
										<span>로그인</span>
									</button>
									<button>
										<img
											src="${pageContext.request.contextPath }/images/배송지search_logo.png"><span>주소검색</span>
									</button>
								</div>
							</div>
						</div>
			...
			<div id="h_second">
				<div class="h_s_1">
					<div id="s_category">
						<span></span> <span>카테고리</span>
						<div>
							<div>
								<ul id="s_c_list">
									<li class="s_c_list_li"
										onclick="location.href='${pageContext.request.contextPath }/category.html';">
										<div>
											<img
												src="https://collection-image.kurly.com/site-category-groups/55/jZZJOSgsf4R9TAvXrdQ999WW2gTFr0cv0Wd21bla.png"
												alt=""> <span>선물하기</span>
										</div>
										<ul>
											<li><div>
									...
									<li class="s_c_list_li"
										...
										<ul>
											...
											<li><div>
													<span>시금치·쌈채소·나물</span>
												</div></li>
											<li><div>
													<span>브로콜리·파프리카·양배추</span>
												</div></li>
											<li><div>
													<span>양파·대파·마늘·배추</span>
												</div></li>
											<li><div>
													<span>오이·호박·고추</span>
												</div></li>
											<li><div>
													<span>냉동·이색·간편채소</span>
												</div></li>
											<li><div>
													<span>콩나물·버섯</span>
												</div></li>
					...
					<ul id="s_list">
						<li
							onclick="location.href='${pageContext.request.contextPath }/category.html';"><span
							class="s_click">신상품</span></li>
						<li
							onclick="location.href='${pageContext.request.contextPath }/category.html';"><span
							class="s_click">베스트</span></li>
						<li
							onclick="location.href='${pageContext.request.contextPath }/category.html';"><span
							class="s_click">알뜰쇼핑</span></li>
						<li
							onclick="location.href='${pageContext.request.contextPath }/category.html';"><span
							class="s_click">특가/혜택</span></li>
					</ul>
					<div id="s_link">
		...
		<div id="section">
			<div class="main_section">
					...
					<div class="m_s_top">
						<div class="m_s_top_swiper_wrap">
							<div class="m_s_top_swiper">
								<div>
									<a><img
										src="${pageContext.request.contextPath }/images/메인섹션 맨상단1.avif"></a>
								</div>
								<div>
									<a><img
										src="${pageContext.request.contextPath }/images/메인섹션 맨상단2.avif"></a>
								</div>
								<div>
									<a><img
										src="${pageContext.request.contextPath }/images/메인섹션 맨상단3.avif"></a>
								</div>
								<div>
									<a><img
										src="${pageContext.request.contextPath }/images/메인섹션 맨상단1.avif"></a>
					...
					<div class="m_s_1">
						<div class="m_s_1_title">
							<div class="m_s_1_title_1">
								<span class="m_s_1_title_1_span"> 이 상품 어때요? </span>
							</div>
						</div>
										...
										<div class="m_s_1_list_1_product">
											<div class="m_s_1_list_1_product_1">
												<div class="m_s_1_list_1_product_1_img">
													<img
														src="https://img-cf.kurly.com/cdn-cgi/image/width=400,format=auto/shop/data/goods/1654826608504l0.jpg"
														alt="상품 이미지">
													<button type="button" class="m_s_1_list_1_product_1_button">
														<img
															src="${pageContext.request.contextPath }/images/상품_장바구니.svg"
															alt="장바구니 아이콘">
													</button>
												</div>
					...
					<div class="m_s_4">
						<div class="m_s_4_title">
							<div class="m_s_4_title_1">
								<span class="m_s_4_title_1_span"> MD의 추천 </span>
							</div>
						</div>
						<ul class="m_s_4_ul">
							<li>
										...
										<div class="m_s_4_list_1_product">
											<div class="m_s_4_list_1_product_1">
												<div class="m_s_4_list_1_product_1_img">
													<img
														src="https://img-cf.kurly.com/cdn-cgi/image/width=400,format=auto/shop/data/goods/1514440709588l0.jpg"
														alt="상품 이미지">
													<button type="button" class="m_s_4_list_1_product_1_button"
														onclick="location.href='${pageContext.request.contextPath }/shopping_basket_loggedIn.html';">
														<img
															src="${pageContext.request.contextPath }/images/상품_장바구니.svg"
															alt="장바구니 아이콘">
													</button>
												...
												<div class="m_s_4_list_1_product_1_content">
													<h3 class="m_s_4_list_1_product_1_content_title">
														[LOTS OF LOVE] 입맛듬뿍 불낙볶음밥 (리뉴얼)</h3>
									...
									<div class="m_s_4_list_1">
										<div class="m_s_4_list_1_product">
											<div class="m_s_4_list_1_product_1">
												<div class="m_s_4_list_1_product_1_img">
													<img
														src="https://img-cf.kurly.com/cdn-cgi/image/width=400,format=auto/shop/data/goods/1653038246425l0.jpeg"
														alt="상품 이미지">
													<button type="button" class="m_s_4_list_1_product_1_button">
														<img
															src="${pageContext.request.contextPath }/images/상품_장바구니.svg"
												...
												<div class="m_s_4_list_1_product_1_content">
													<h3 class="m_s_4_list_1_product_1_content_title">춘천 국물
														닭갈비 떡볶이</h3>
													<div class="m_s_4_list_1_product_1_content_price">
														<div class="m_s_4_list_1_product_1_content_price_1">
															<span class="m_s_4_list_1_product_1_content_price_1_1">
						...
						<a href="${pageContext.request.contextPath }/category.html"
							class="m_s_4_a"><span class="m_s_4_a_span">샐러드·간편식
								전체보기</span></a>
					</div>
				</div>
				<!-- 상단 버튼 추가 섹션 -->
					...
					<div class="m_s_5">
						<div class="m_s_5_title">
							<div class="m_s_5_title_1">
								<span class="m_s_5_title_1_span_1"> 지금 가장 핫한 상품 </span> <span
									class="m_s_5_title_1_span_2"> <img
									src="${pageContext.request.contextPath }/images/섹션타이틀이동.svg"
									alt="더보기 아이콘">
								</span>
							</div>
						</div>
										...
										<div class="m_s_5_list_1_product">
											<div class="m_s_5_list_1_product_1">
												...
												<div class="m_s_5_list_1_product_1_content">
													<h3 class="m_s_5_list_1_product_1_content_title">춘천 국물
														닭갈비 떡볶이</h3>
					...
					<div class="m_s_2">
						<div class="m_s_2_title">
							<div class="m_s_2_title_1">
								<span class="m_s_2_title_1_span_1"> 컬리의 레시피 </span> <span
									class="m_s_2_title_1_span_2"> <img
									src="${pageContext.request.contextPath }/images/섹션타이틀이동.svg"
									alt="더보기 아이콘">
								</span>
							</div>
								...
								<div class="m_s_2_list_swiper_wrap">
									<div class="m_s_2_list_1">
										<div class="m_s_2_list_1_product">
											<a
												href="${pageContext.request.contextPath }/recipe_page.html"
												class="m_s_2_list_1_product_a">
												<div class="m_s_2_list_1_product_a_img">
													<img
														src="${pageContext.request.contextPath }/images/로스티드 닭 다리_날개.webp">
												</div>
												<div class="m_s_2_list_1_product_a_d">로스티드 닭 다리&날개</div>
											</a>
										</div>
										<div class="m_s_2_list_1_product">
											<a
				...
				<div>
					<div class="m_s_a">
						<div class="m_s_a_1">
							<a class="m_s_a_1_1"> <img
								src="${pageContext.request.contextPath }/images/광고.webp" alt>
							</a>
						</div>
					</div>
				</div>
					...
					<div class="m_s_3">
						...
						<div class="m_s_3_list">
							...
							<div class="m_s_3_list_swiper">
								<div class="m_s_3_list_swiper_wrap">
									<div class="insta_div">
										<a href="https://www.instagram.com/marketkurly_regram/"><img
											src="${pageContext.request.contextPath }/images/instagram_img1.jpg"></a>
									</div>
									<div class="insta_div">
										<a href="https://www.instagram.com/marketkurly_regram/"><img
											src="${pageContext.request.contextPath }/images/instagram_img1.jpg"></a>
									...
									<div class="insta_div">
										<a href="https://www.instagram.com/marketkurly_regram/"><img
											src="${pageContext.request.contextPath }/images/instagram_img2.jpg"></a>
									</div>
									<div class="insta_div">
										<a href="https://www.instagram.com/marketkurly_regram/"><img
											src="${pageContext.request.contextPath }/images/instagram_img2.jpg"></a>
									...
									<div class="insta_div">
										<a href="https://www.instagram.com/marketkurly_regram/"><img
											src="${pageContext.request.contextPath }/images/instagram_img3.jpg"></a>
									</div>
									<div class="insta_div">
										<a href="https://www.instagram.com/marketkurly_regram/"><img
											src="${pageContext.request.contextPath }/images/instagram_img3.jpg"></a>
						...
						<div class="m_s_3_tlink">
							...
							<a href="https://www.instagram.com/marketkurly_regram/"
								target="_blank" rel="nooperner noreferrer">@marketkurly_regram</a>
						</div>
					</div>
				</div>
			</div>
			...
			<nav id="right_nav">
				<a class="right_nav_iLink"><img
					src="https://res.kurly.com/_next/static/images/deliveryInfo_20220701-a7b19dac069402e4b2aea7edbed0f6e0.png"></a>
				<ul class="right_nav_list">
					<li><a>등급별 혜택</a></li>
					<li><a
						href="${pageContext.request.contextPath }/recipe_list.html">레시피</a></li>
				</ul>
			</nav>
		</div>
		<div id="footer">
			<div class="f_f">
				<div class="f_f_1">
					<div class="f_f_1_1">
						...
						<div>
							<div>
								...
								<div>
									월~토요일 | 오전7시-오후6시<br>일/공휴일 | 오전7시-오후1시
								</div>
							</div>
							<div>
							...
							<div>
								...
								<div>
									월~금요일 | 오전9시-오후6시<br>점심시간 | 낮12시-오후1시
								</div>
							</div>
						</div>
						<div>
							비회원 문의 : <a href="#">help@kurlycorp.com</a> <br>비회원 대량주문 문의
					...
					<div class="f_f_1_2">
						...
						<div>
							법인명 (상호) : 주식회사 컬리 | 사업자등록번호 : 261-81-23567 <a>사용자정보 확인</a> <br>통신판매업
							: 제 2018-서울강남-01646 호 | 개인정보보호책임자 : 이원준 <br>주소 : 서울특별시 강남구
							테헤란로 133, 18층(역삼동) | 대표이사 : 김슬아 <br>입점문의 : <a>입점문의하기</a> |
							제휴문의 : <a>business@kurlycorp.com</a> <br>채용문의 : <a>recruit@kurlycorp.com</a>
							<br>팩스 : 070 - 7500 - 6098
						</div>
						<ul>
							<li><a target="_blank"
								href="https://www.instagram.com/marketkurly/"><img
									src="${pageContext.request.contextPath }/images/instagram_logo.png"
									width="30" height="30"></a></li>
							<li><a target="_blank"
								href="https://www.facebook.com/marketkurly"><img
									src="${pageContext.request.contextPath }/images/facebook_logo.png"
									width="30" height="30"></a></li>
							<li><a target="_blank"
								href="https://blog.naver.com/marketkurly"><img
									src="${pageContext.request.contextPath }/images/naverblog_logo.png"
									width="30" height="30"></a></li>
							<li><a target="_blank"
								href="https://m.post.naver.com/marketkurly"><img
									src="${pageContext.request.contextPath }/images/naverpost_logo.png"
									width="30" height="30"></a></li>
							<li><a target="_blank"
								href="https://www.youtube.com/channel/UCfpdjL5pl-1qKT7Xp4UQzQg"><img
									src="${pageContext.request.contextPath }/images/youtube_logo.png"
									width="30" height="30"></a></li>
						</ul>
					</div>
				</div>
				<div class="f_f_2">
					<button>
						...
						<p>
							[인증범위] 마켓컬리 쇼핑몰 서비스 개발 · 운영<br>(심사받지 않은 물리적 인프라 제외)<br>[유효기간]
